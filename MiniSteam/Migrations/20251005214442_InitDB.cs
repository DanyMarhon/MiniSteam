    ...
    public partial class InitDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GenrePerGames", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlatformPerGames", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GenrePerGames_IdGame",
                table: "GenrePerGames",
                column: "IdGame");

            migrationBuilder.CreateIndex(
                name: "IX_GenrePerGames_IdGenre",
                table: "GenrePerGames",
                column: "IdGenre");

            migrationBuilder.CreateIndex(
                name: "IX_PlatformPerGames_IdGame",
                table: "PlatformPerGames",
                column: "IdGame");

            migrationBuilder.CreateIndex(
                name: "IX_PlatformPerGames_IdPlatform",
                table: "PlatformPerGames",
                column: "IdPlatform");
        }
